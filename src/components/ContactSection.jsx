  ...
  return (
    <section id="contact" className="py-10 px-4 bg-[#f8fafc] relative overflow-hidden border-b border-slate-100 flex flex-col items-center justify-center">
      <div className="max-w-md mx-auto w-full text-center flex flex-col items-center">
        ...
        {/* WhatsApp Button */}
        <a
          href="https://wa.me/918826064806"
          target="_blank"
          rel="noopener noreferrer"
          className="w-full sm:w-[90%] bg-[#22c55e] hover:bg-[#1da851] text-white py-4 px-6 rounded-2xl flex items-center justify-center gap-3 font-bold text-xl sm:text-2xl transition-all shadow-md hover:shadow-lg mb-4"
        >
          {/* WhatsApp SVG Icon */}
          <svg
        ...
        <div className="w-full sm:w-[90%] flex flex-col gap-4">
          <a 
            href="mailto:contact@itopper.academy"
            className="w-full bg-white border border-slate-200 text-slate-700 py-3 px-4 rounded-2xl flex items-center justify-center gap-3 font-bold text-base sm:text-lg transition-all shadow-sm hover:shadow-md"
          >
            ✉️ contact@itopper.academy
          </a>
          <a 
            href="mailto:itopperiasacademy@gmail.com"
            className="w-full bg-white border border-slate-200 text-slate-700 py-3 px-4 rounded-2xl flex items-center justify-center gap-3 font-bold text-base sm:text-lg transition-all shadow-sm hover:shadow-md"
          >
            ✉️ itopperiasacademy@gmail.com
          </a>
        </div>
      </div>
    </section>
